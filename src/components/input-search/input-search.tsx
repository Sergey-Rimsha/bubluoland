...
import iconSearchActive from '../../assets/icon/icon_search_active.svg';
...
export const InputSearch = React.memo(
  ({ search, onChangeSearchInput }: InputSearchPropsI) => {
    ...
    return (
      <div className={s.input}>
        ...
        <div
          className={classNames(s.input__box, { [`${s.input__box_show}`]: focusInput })}
        >
          <input
